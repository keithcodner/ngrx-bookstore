...
INSERT INTO `user` (`id`, `name`, `username`, `email`, `password`, `token`, `other`, `created_at`) VALUES
	(1, 'James', 'jbond', 'jbond@gmail.com', '123', '993ab841-a33a-4d39-9c59-aabb6b7b4e0e', NULL, NULL),
	(2, 'Alex', 'arosen', 'arose@gmail.com', '123', 's66fiw1-a33a-4d39-9c59-ooi87ythjm', NULL, NULL);
